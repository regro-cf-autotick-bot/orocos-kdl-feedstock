...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/orocos-kdl-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/orocos-kdl-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add orocos-kdl python-orocos-kdl
# for installing globally
pixi global install orocos-kdl python-orocos-kdl
```
...
It is possible to list all of the versions of `orocos-kdl` available on your platform:
...
```
pixi search orocos-kdl --channel conda-forge
```
